...
export default function ShopCTA() {
  return (
    <section className="mx-auto max-w-content px-4 py-14 text-center sm:px-6 sm:py-20">
      ...
      <p className="mx-auto mt-3 max-w-md text-base text-ink/70 sm:text-lg">
      ...
      <Link
        href="/shop"
        className="mt-6 inline-flex min-h-[44px] items-center justify-center rounded-full bg-coral px-8 py-3 text-base font-semibold text-white shadow-sm transition hover:bg-coral-dark"
      >
        Browse the Shop
      </Link>
    </section>
